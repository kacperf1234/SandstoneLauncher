...
namespace KacpiiToZiomal.SandstoneLauncher.Minecraft.Models
{
    public class MojangUser
    {
        ...
        [JsonProperty("registeredAt")] public ulong RegisteredAt { get; set; }

        [JsonProperty("passwordChangedAt")] public ulong PasswordChangedAt { get; set; }

        [JsonProperty("dateOfBirth")] public ulong DateOfBirth { get; set; }

        [JsonProperty("suspensed")] public bool Suspensed { get; set; }
        ...
        [JsonProperty("hashed")] public bool Hashed { get; set; }

        [JsonProperty("fromMigratedUser")] public bool FromMigratedUser { get; set; }
    }
}